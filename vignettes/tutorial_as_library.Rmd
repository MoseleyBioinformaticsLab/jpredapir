...
```{r, echo = FALSE}
cat(scan(use_file, what = character(), quiet = TRUE), sep = "\n")
```
...
```{r, echo = FALSE}
cat(scan(system.file("exampledata/msa_fasta.example", package = "jpredapir"), what = character(),
sep = "\n", quiet = TRUE), sep = "\n")
```
...
```{r, echo = FALSE}
cat(scan(system.file("exampledata/msa_blc.example", package = "jpredapir"), what = character(),
sep = "\n", quiet = TRUE), sep = "\n")
```
